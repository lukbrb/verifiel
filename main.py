import sys
from verifiel.lecture import User, get_credentials, write_data
from verifiel.affichage import display_servers, choix_action
from verifiel.desabonnement import lance_desabonnement
